...
# As it was not speciifed I counted teh number of e's and E's within the text file. 

filename = str(input("Please enter the name of the text file (must be *.txt file):")) # this line instructs teh user to input teh anme of the text file
...
with open(filename, "r") as f:  #this line opens the file inputted (filename) in read mode ("r")
    ...
    letter_count = filedata.count("e") + filedata.count("E") #count() count sthe number of e's in the data that was read from the file
    print(letter_count) 
