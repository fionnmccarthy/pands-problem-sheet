...
# From research I gathered the formula used here for string slicing is - str_object[start_pos:end_pos:step].
# As we want the full length of the string we do no enter the 'start_pos' or the 'end_pos' as we will use the full string.
# The '-' below is used to reverse the string.
